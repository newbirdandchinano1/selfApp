...
export function FinanceBudgetCardSkeleton({ colors }: FinanceSkeletonProps) {
  return (
    <SkeletonCard
      tone={{ surface: colors.cardBg, outline: colors.outline, cardBg: colors.cardBg }}
      shadowed
    ...
    >
      ...
      <View style={styles.trendBlock}>
        ...
        <Skeleton width="100%" height={96} borderRadius={14} style={styles.trendChart} />
        ...
        {Array.from({ length: 3 }).map((_, index) => (
          <View key={index} style={styles.txnRow}>
            ...
            <View
              style={[
                styles.txnMain,
                index < 2 ? { borderBottomColor: colors.outline, borderBottomWidth: StyleSheet.hairlineWidth } : null,
              ]}
            >
